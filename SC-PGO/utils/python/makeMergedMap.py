...
data_dir = "/media/jeff/PineappleJC/bag_and_pcd/fast_lio2_result/" # should end with / 
scan_idx_range_to_stack = [0, 1089] # if you want a whole map, use [0, len(scan_files)]
node_skip = 1
