...
plot_ind = range(7,10)
a_pre=np.loadtxt('filter_comp/ordinary_filter/mat_pre.txt')
a_out=np.loadtxt('filter_comp/ordinary_filter/mat_out.txt')
time=a_pre[:,0]
...
imu=np.loadtxt('filter_comp/ordinary_filter/imu.txt')
time=imu[:,0]
...
c="red"
a_out1=np.loadtxt('filter_comp/fea_filter/mat_out.txt')
a_out2=np.loadtxt('filter_comp/ordinary_filter/mat_out.txt')
...
ax2.set_ylim([-2000, 1750])

plt.xticks([1,2], ('Fea_filter Scene', 'Ordinary_filter Scene 1'))
# # print(time_se)
# # print(a_out3[:,2])
plt.grid()
